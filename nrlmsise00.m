...
% -------------------------------------------------------------------- %
function [output] = nrlmsise00(input)
...
% for i=1:17
%     input(i).doy=332.125;
%     input(i).year=2021; % without effect
%     input(i).sec=10800;
%     input(i).alt=1.089703368956120e+03;
%     input(i).g_lat=2.672654065452757;
%     input(i).g_long=2.796715095783112e+02;
%     input(i).lst=20.3;
%     input(i).f107A=150;
%     input(i).f107=150;
%     input(i).ap=4;
